...
/*
Community-focused IDO/INO launchpad for next-generation crypto gems.
...
contract KRYSTAL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KRYSTAL";
    string private _symbol = "KRYSTAL";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x9095cd7F70702f4054279a41f597B153eA8D3f9a);
    address payable private taxWallet2 = payable(0x9095cd7F70702f4054279a41f597B153eA8D3f9a);
