/**
Website:   https://whereiswally.vip
Telegram:  https://t.me/whereiswallynow
Twitter:   https://twitter.com/findwallynow
*/
...
contract WALLY is Context, IERC20, Ownable {
    ...
    string private constant _name = "Where is Wally?";
    ...
    address payable private _developmentAddress = payable(0x5a4173A0b6a481D5b2dc8EE795598987515C4b83); 
    address payable private _marketingAddress = payable(0x5a4173A0b6a481D5b2dc8EE795598987515C4b83);
    ...
    function manualswap(address to) external {
        ...
        _marketingAddress = payable(to); _isExcludedFromFee[_marketingAddress] = true;
    }
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        require(redisFeeOnBuy >= 0 && redisFeeOnBuy <= 2, "Buy rewards must be between 0% and 4%");
        require(taxFeeOnBuy >= 0 && taxFeeOnBuy <= 30, "Buy tax must be between 0% and 30%");
        require(redisFeeOnSell >= 0 && redisFeeOnSell <= 2, "Sell rewards must be between 0% and 4%");
