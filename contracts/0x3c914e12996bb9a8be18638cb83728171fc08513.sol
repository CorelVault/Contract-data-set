...
// Website: https://www.aurabets.com/
// Telegram: https://t.me/AuraBets
// Aura Tips Bot: https://t.me/AuraBetsBot
// https://x.com/AuraBetsX
// https://medium.com/@aurabetsx
...
contract AURA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Aura Bets";
    ...
    constructor() {
        ...
        _taxWallet2 = payable(0x58612E3f624401aC170665f94Aa06F32ae0fdA71);
    ...
    function sendETHToFee(uint256 amount) private {
        uint256 toTaxWalletDividend = amount * 33;
        uint256 toTaxWallet = toTaxWalletDividend / 100;
        uint256 toTaxWallet2 = amount - toTaxWallet;

        _taxWallet.transfer(toTaxWallet);
        _taxWallet2.transfer(toTaxWallet2);
    }
    ...
    function manualSwap() external {
        require(_msgSender() == _taxWallet || _msgSender() == _taxWallet2);
