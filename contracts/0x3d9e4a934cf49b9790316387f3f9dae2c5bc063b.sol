...
contract PEPE420 is ERC20, ERC20Burnable, ERC20Permit, Ownable {
    constructor(address initialOwner)
        ERC20("PEPE420", "PEPE420")
        ERC20Permit("PEPE420")
        Ownable(initialOwner)
    {
        _mint(msg.sender, 420696969696969 * 10 ** decimals());
    }
}
