/**
 ...
 ____   __ __  ____    ____  _        ___      _____  __ __  ____  
|    \ |  |  ||    \  /    || |      /  _]    |     ||  |  ||    \ 
|  o  )|  |  ||  _  ||   __|| |     /  [_     |   __||  |  ||  _  |
|     ||  |  ||  |  ||  |  || |___ |    _]    |  |_  |  |  ||  |  |
|  O  ||  :  ||  |  ||  |_ ||     ||   [_  __ |   _] |  :  ||  |  |
|     ||     ||  |  ||     ||     ||     ||  ||  |   |     ||  |  |
|_____| \__,_||__|__||___,_||_____||_____||__||__|    \__,_||__|__|
...
contract BUNGLE is ERC20, Ownable {
    constructor() ERC20(
        "BUNGLE", "BUNGLE"
        )
         {
        _mint(
            msg.sender, 9999999999999 * 10 ** decimals()
            );
    }
}
