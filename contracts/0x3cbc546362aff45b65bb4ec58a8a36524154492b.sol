...
3 important rules before you join $BULL

 
1. $BULL is an entirely community-driven project, with an exclusive focus on the community itself.
 
2. The esteemed $BULL enthusiasts have no interest in promotional or Raider offers; 
 
3. Callers are welcome to join and participate for free. 
...
contract BULL is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Blast Up Lil Liq";
