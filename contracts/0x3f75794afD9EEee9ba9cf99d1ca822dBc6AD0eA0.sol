...
contract ZergRush  is Context, IERC20, Ownable {
    ...
    uint256 private _initialSellTax=53;
    ...
    string private constant _name = unicode"Zerg Rush";
    string private constant _symbol = unicode"ZERG";
